...
// *Скрипт показа аватара* //
<<<<<<< HEAD
// *Оригинал: minotar* //
// *Инструкция: LiveD* //
=======
// *Оригинал: tixsus1 //
>>>>>>> 22cf97cfee49000a32ff97943f575ec07dd54519

$size = isset($_GET['s']) ? (($_GET['s']<300) ? (($_GET['s']>8) ? $_GET['s'] : 8) : 300) : 48;
$user = isset($_GET['u']) ? $_GET['u'] : 'char';

function get_avatar($user = 'char') {
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, 'https://naturcraft.ru/recloud/modules/cabinet/uploads/skins/' . $user . '.png');//<- правим тут
    ...
    curl_close($ch);
    if($status!='200') {
        // Стандартный аватар: http://www.minecraft.net/char.png
